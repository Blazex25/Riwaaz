...
import { Button, Grid, Rating, Box, LinearProgress, Typography } from '@mui/material'
            ...
            <div className="pt-6">
                ...
                <section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <div className='flex flex-wrap space-x-5 justify-center'>
                            {product.images.map((item) => <div className='aspect-h-2 aspect-w-3 overflow-hidden rounded-lg max-w-[5rem] max-h-[5rem] mt-5'>
                                <img
                                    src={item.src}
                                    alt={item.alt}
                ...
                <section>
                    ...
                    <div className='border p-5'>
                        <Grid container sx={{ gap: '12rem' }}> {/* ~7.5cm space between columns */}
                            {/* Reviews Section */}
                            <Grid item xs={7}>
